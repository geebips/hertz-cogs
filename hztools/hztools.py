...
class hztools(commands.Cog):
	...
	async def _setproxyip(self, ctx, IP: str, PORT: str):
		...
		if IP:
			...
			embed = discord.Embed(color=await ctx.embed_color(), title="Proxy URL/IP set.").set_thumbnail(url=self.image).set_footer(text=self.footer, icon_url=self.image)
	...
	async def _setproxyauth(self, ctx, USER: str, PASS: str):
		...
		if USER:
			...
			embed = discord.Embed(color=await ctx.embed_color(), title="Proxy authentication set.").set_thumbnail(url=self.image).set_footer(text=self.footer, icon_url=self.image)
			await ctx.send(embed=embed)
	...
	async def _setemoji(self, ctx, EMOJIID: int):
		...
		if EMOJIID:
			...
			embed = discord.Embed(color=await ctx.embed_color(), title="Emoji ID set.").set_thumbnail(url=self.image).set_footer(text=self.footer, icon_url=self.image)
			await ctx.send(embed=embed)
	...
	async def _setc99api(self, ctx, KEY: str):
		...
		if KEY:
			...
			embed = discord.Embed(color=await ctx.embed_color(), title="API Key set.").set_thumbnail(url=self.image).set_footer(text=self.footer, icon_url=self.image)
			await ctx.send(embed=embed)
	...
	async def _setwrapi(self, ctx, KEY: str):
		...
		if KEY:
			...
			embed = discord.Embed(color=await ctx.embed_color(), title="Webresolver.nl API Key set").set_thumbnail(url=self.image).set_footer(text=self.footer, icon_url=self.image)
			await ctx.send(embed=embed)
	...
	async def _whois(self, ctx, URL: str):
		...
		if not self.wr_key:
			embed = discord.Embed(color=await ctx.embed_color(), title="Error:", description="No Webresolver.nl Key set... Try `[p]setup setwrapi`").set_thumbnail(url=self.image).set_footer(text=self.footer, icon_url=self.image)
			await ctx.send(embed=embed)
			return
	...
	async def _icmp(self, ctx, IP: str):
		...
		async with ctx.typing():
			async with self.session.get(self.webresolver, params={"key": self.wr_key, "html": "0", "action": "ping", "string": IP}) as resp:
				embed = discord.Embed(color=await ctx.embed_color(), title="Results:", description=await resp.text()).set_thumbnail(url=self.image).set_footer(text=self.footer, icon_url=self.image)
	...
	async def _skype(self, ctx, SKYPE: str):
		...
		async with ctx.typing():
			async with self.session.get(self.webresolver, params={"key": self.wr_key, "html": "0", "action": "resolve", "string": SKYPE}) as resp:
				embed = discord.Embed(color=await ctx.embed_color(), title="Skype Results:", description=await resp.text()).set_thumbnail(url=self.image).set_footer(text=self.footer, icon_url=self.image)
				await message.edit(embed=embed)
	...
	async def _skypedb(self, ctx, SKYPE: str):
		...
		async with ctx.typing():
			async with self.session.get(self.webresolver, params={"key": self.wr_key, "html": "0", "action": "resolvedb", "string": SKYPE}) as resp:
				embed = discord.Embed(color=await ctx.embed_color(), title="Skype DB Results:", description=await resp.text()).set_thumbnail(url=self.image).set_footer(text=self.footer, icon_url=self.image)
				await message.edit(embed=embed)
	...
	async def _cloudflare(self, ctx, URL: str):
		...
		async with ctx.typing():
			async with self.session.get(self.webresolver, params={"key": self.wr_key, "html": "0", "action": "cloudflare", "string": URL}) as resp:
				embed = discord.Embed(color=await ctx.embed_color(), title="Cloudflare Info:", description=await resp.text()).set_thumbnail(url=self.image).set_footer(text=self.footer, icon_url=self.image)
				await message.edit(embed=embed)
	...
	async def _geoip(self, ctx, INPUT: str):
		...
		async with ctx.typing():
			async with self.session.get(self.webresolver, params={"key": self.wr_key, "html": "0", "action": "geoip", "string": INPUT}) as resp:
				embed = discord.Embed(color=await ctx.embed_color(), title="Geolocation Results:", description=await resp.text()).set_thumbnail(url=self.image).set_footer(text=self.footer, icon_url=self.image)
				await message.edit(embed=embed)
	...
	async def _headers(self, ctx, URL: str):
		...
		async with ctx.typing():
			async with self.session.get(self.webresolver, params={"key": self.wr_key, "html": "0", "action": "header", "string": URL}) as resp:
				embed = discord.Embed(color=await ctx.embed_color(), title="Headers:", description=await resp.text()).set_thumbnail(url=self.image).set_footer(text=self.footer, icon_url=self.image)
				await message.edit(embed=embed)
	...
	async def _portscan(self, ctx, PORT: str, IP: str):
		...
		async with ctx.typing():
			async with self.session.get(self.webresolver, params={"key": self.wr_key, "html": "0", "action": "portscan", "string": IP, "port": PORT}) as resp:
				embed = discord.Embed(color=await ctx.embed_color(), title="Port Scan Results:", description=await resp.text()).set_thumbnail(url=self.image).set_footer(text=self.footer, icon_url=self.image)
				await message.edit(embed=embed)
	...
	async def _i2s(self, ctx, IP: str):
		...
		async with ctx.typing():
			async with self.session.get(self.webresolver, params={"key": self.wr_key, "html": "0", "action": "ip2websites", "string": IP}) as resp:
				embed = discord.Embed(color=await ctx.embed_color(), title="IP to Skype:", description=await resp.text()).set_thumbnail(url=self.image).set_footer(text=self.footer, icon_url=self.image)
				await message.edit(embed=embed)
	...
	async def _emailtoskype(self, ctx, EMAIL: str):
		...
		async with ctx.typing():
			async with self.session.get(self.webresolver, params={"key": self.wr_key, "html": "0", "action": "phonenumbercheck", "string": EMAIL}) as resp:
				embed = discord.Embed(color=await ctx.embed_color(), description=await resp.text()).set_thumbnail(url=self.image).set_footer(text=self.footer, icon_url=self.image)
				await message.edit(embed=embed)
	...
	async def _skypetoemail(self, ctx, SKYPE: str):
		...
		async with ctx.typing():
			async with self.session.get(self.webresolver, params={"key": self.wr_key, "html": "0", "action": "skype2email", "string": SKYPE}) as resp:
				embed = discord.Embed(color=await ctx.embed_color(), title="Skype to Email:", description=await resp.text()).set_thumbnail(url=self.image).set_footer(text=self.footer, icon_url=self.image)
				await message.edit(embed=embed)
	...
	async def _phone(self, ctx, NUMBER: str):
		...
		async with ctx.typing():
			async with self.session.get(self.webresolver, params={"key": self.wr_key, "html": "0", "action": "phonenumbercheck", "string": NUMBER}) as resp:
				embed = discord.Embed(color=await ctx.embed_color(), title="Phone Information:", description=await resp.text()).set_thumbnail(url=self.image).set_footer(text=self.footer, icon_url=self.image)
				await message.edit(embed=embed)
	...
	async def _disposable(self, ctx, EMAIL: str):
		...
		async with ctx.typing():
			async with self.session.get(self.webresolver, params={"key": self.wr_key, "html": "0", "action": "disposable_email", "string": EMAIL}) as resp:
				embed = discord.Embed(color=await ctx.embed_color(), title="Disposable Email Results:", description=await resp.text()).set_thumbnail(url=self.image).set_footer(text=self.footer, icon_url=self.image)
				await message.edit(embed=embed)
	...
	async def _mtr(self, ctx, IP: str):
		...
		async with ctx.typing():
			async with self.session.get(self.hackertarget+'/mtr/', params={"key": self.wr_key, "q": IP}) as resp:
				embed = discord.Embed(color=await ctx.embed_color(), title="MTR Results:", description=await resp.text()).set_thumbnail(url=self.image).set_footer(text=self.footer, icon_url=self.image)
				await message.edit(embed=embed)
	...
	async def _nmap(self, ctx, IP: str):
		...
		if not self.c99_key:
			embed = discord.Embed(color=await ctx.embed_color(), title="Error:", description="No C99.nl Key set... Try `[p]setup setc99api`").set_thumbnail(url=self.image).set_footer(text=self.footer, icon_url=self.image)
			await ctx.send(embed=embed)
			return
		embed = discord.Embed(color=await ctx.embed_color(), title=str(self.emoji))
		message = await ctx.send(embed=embed)
	...
	async def _fakename(self, ctx, GENDER: str):
		...
		async with ctx.typing():
			async with self.session.get(self.c99+'/randomperson', params={"key": self.c99_key, "gender": GENDER, "json": "json"}) as resp:
				...
				embed=discord.Embed(color=await ctx.embed_color()).set_thumbnail(url=self.image).set_footer(text=self.footer, icon_url=self.image)
	...
	async def _btcbalance(self, ctx, ADDRESS: str):
		...
		async with ctx.typing():
			async with self.session.get(self.c99+'/bitcoinbalance', params={"key": self.c99_key, "address": ADDRESS}) as resp:
				embed = discord.Embed(color=await ctx.embed_color(), title=await resp.text()).set_thumbnail(url=self.image).set_author(name="BTC", icon_url="https://i.imgur.com/uuZLtm6.png").set_footer(text=self.footer, icon_url=self.image)
				await message.edit(embed=embed)
	...
	async def _etheriumbalance(self, ctx, ADDRESS: str):
		...
		async with ctx.typing():
			async with self.session.get(self.c99+'/ethereumbalance', params={"key": self.c99_key, "address": ADDRESS}) as resp:
				embed = discord.Embed(color=await ctx.embed_color(), description=await resp.text()).set_thumbnail(url=self.image).set_author(name="Etherium", icon_url="https://i.imgur.com/bJO1SSN.png").set_footer(text=self.footer, icon_url=self.image)
				await message.edit(embed=embed)
		...
		async with ctx.typing():
			async with self.session.get(self.c99+'/createscreenshot', params={"key": self.c99_key, "url": URL}) as resp:
				if "Invalid" in await resp.text():
					embed = discord.Embed(color=await ctx.embed_color(), title="Invalid Syntax", description="Example: https://google.com").set_thumbnail(url=self.image).set_footer(text=self.footer, icon_url=self.image)
					await message.edit(embed=embed)
				else:
					embed = discord.Embed(color=await ctx.embed_color(), title="Website Screenshot:", description="The screenshots may not work with some websites which have a firewall such as Cloudflare or DDOSGuard.").set_thumbnail(url=self.image).set_image(url=await resp.text()).set_footer(text=self.footer, icon_url=self.image)
					await message.edit(embed=embed)
		...
		async with ctx.typing():
			async with self.session.get(self.c99+'/gif', params={"key": self.c99_key, "keyword": KEYWORD, "json": "json"}) as resp:
				if "No images found." in await resp.text():
					embed = discord.Embed(color=await ctx.embed_color(), title="No images found.", description="There were no images found by that keyword, please try using a similar keyword.").set_thumbnail(url=self.image).set_footer(text=self.footer, icon_url=self.image)
					await message.edit(embed=embed)
				else:
					data = await resp.json()
					result = data['images']
	...
	async def _checkdomain(self, ctx, DOMAIN: str):
		...
		async with ctx.typing():
			async with self.session.get(self.c99+'/domainchecker', params={"key": self.c99_key, "domain": DOMAIN}) as resp:
				embed = discord.Embed(color=await ctx.embed_color(), title="Domain Availability:", description=await resp.text()).set_thumbnail(url=self.image).set_footer(text=self.footer, icon_url=self.image)
				await message.edit(embed=embed)
	...
	async def _define(self, ctx, WORD: str):
		...
		async with ctx.typing():
			async with self.session.get(self.c99+'/dictionary', params={"key": self.c99_key, "word": WORD}) as resp:
				embed = discord.Embed(color=await ctx.embed_color(), title="Definition:", description=await resp.text()).set_thumbnail(url=self.image).set_footer(text=self.footer, icon_url=self.image)
				await message.edit(embed=embed)
	...
	async def _define(self, ctx, INPUT: str, LANG: str):
		...
		async with ctx.typing():
			async with self.session.get(self.c99+'/translate', params={"key": self.c99_key, "text": INPUT, "tolanguage": LANG}) as resp:
				embed = discord.Embed(color=await ctx.embed_color(), description=await resp.text()).set_author(name=ctx.author, icon_url=avatar).set_thumbnail(url=self.image).set_footer(text=self.footer, icon_url=self.image)
				await message.edit(embed=embed)
